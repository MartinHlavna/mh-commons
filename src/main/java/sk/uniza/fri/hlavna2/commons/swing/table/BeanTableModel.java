package sk.uniza.fri.hlavna2.commons.swing.table;

import java.lang.reflect.*;
import java.util.*;
import sk.uniza.fri.hlavna2.commons.swing.table.annotations.DisplayPriority;
import sk.uniza.fri.hlavna2.commons.swing.table.annotations.TableCollumnName;
import sk.uniza.fri.hlavna2.commons.swing.table.annotations.TableHidden;

/**
 * The BeanTableModel will use reflection to determine the columns of data to be displayed in the table model.
 * Reflection is used to find all the methods declared in the specified bean. The criteria used for adding columns to
 * the model are:
 *
 * a) the method name must start with either "get" or "is" b) the parameter list for the method must contain 0
 * parameters
 *
 * You can also specify an ancestor class in which case the declared methods of the ancestor and all its descendents
 * will be included in the model.
 *
 * A column name will be assigned to each column based on the method name.
 *
 * The cell will be considered editable when a corresponding "set" method name is found.
 *
 * Reflection will also be used to implement the getValueAt() and setValueAt() methods.
 */
public class BeanTableModel<T> extends RowTableModel<T> {
     ...
     *
     * @param beanClass class of the beans that will be added to the model. The class is also used to determine the
     * columns that will be displayed in the model
     */
     ...
     * @param ancestorClass the methods of this class and its descendents down to the bean class can be included in the
     * model.
     */
     ...
     * @exception IndexOutOfBoundsException if an invalid row or column was given
     */
    @Override
     ...
     *
     * Override to make sure you can't set a column editable that doesn't have a defined setter method.
     *
